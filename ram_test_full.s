...
INIT_LOOP:
    ...
    BNE VERIFICATION_FAILED_IN ; Branch if verification fails
    

    INX ; Increment X register    
    CPX #$FF ; Check if X has reached 255
    BNE INIT_LOOP ; If not, continue the loop
...
; complete verification    
    ...
    INX ; Increment X register
    CPX #$FF ; Check if X has reached 255
    BNE VER ; If not, continue the loop
